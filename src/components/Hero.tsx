...
const Hero: React.FC = () => {
  return (
    ...
    >
      {/* Background orbs */}
      <div className="absolute top-[-100px] right-[-150px] w-[600px] h-[600px] rounded-full bg-blue-700/25 blur-[80px] pointer-events-none" />
      <div className="absolute bottom-[-50px] left-[-100px] w-[400px] h-[400px] rounded-full bg-[#38bdf8]/12 blur-[80px] pointer-events-none" />
      <div className="absolute top-[40%] left-[40%] w-[200px] h-[200px] rounded-full bg-amber-400/10 blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-[1200px] mx-auto w-full grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <ScrollAnimation>
          <div>
            ...
            <p className="text-white/60 text-lg leading-[1.75] max-w-[480px] mb-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-br from-blue-500 to-[#38bdf8] text-white px-8 py-4 rounded-xl font-sora font-bold text-base shadow-[0_8px_32px_rgba(59,130,246,0.35)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(59,130,246,0.5)] no-underline"
            >
        ...
        <ScrollAnimation delay={2} className="hidden md:flex justify-center">
          <div className="relative w-full max-w-[380px]">
            {/* Card */}
            <div className="relative bg-white/[0.04] border border-white/10 rounded-3xl p-10 backdrop-blur-xl">
              {/* Top shimmer line */}
              <div className="absolute top-[-1px] left-5 right-5 h-[1px] bg-gradient-to-r from-transparent via-[#38bdf8] to-transparent" />

              {/* Icon */}
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-[#38bdf8] flex items-center justify-center mb-6 shadow-[0_8px_24px_rgba(59,130,246,0.4)]">
            ...
            {/* Floating chips */}
            <div className="animate-float absolute bottom-[-20px] left-[-30px] flex items-center gap-2 bg-[#0d1f3c]/90 border border-white/12 rounded-xl px-4 py-3 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.3)] text-sm text-white font-semibold">
              <ShieldCheck size={14} className="text-[#38bdf8]" />
              Emissão Segura
            </div>
            <div className="animate-float-delay absolute top-[-15px] right-[-20px] flex items-center gap-2 bg-[#0d1f3c]/90 border border-white/12 rounded-xl px-4 py-3 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.3)] text-sm text-white font-semibold">
